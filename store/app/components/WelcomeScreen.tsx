        ...
        {emailSent && (
          <div className="mb-6 p-4 bg-sky-50 border border-sky-200 rounded-lg">
            ...
            <div className="mt-3">
              <Button
                ...
                className="h-9 bg-white border border-gray-300 hover:bg-sky-50 text-gray-700 text-sm font-medium rounded-lg"
              >
                確認メールを再送
              </Button>
            </div>
          ...
          <form onSubmit={handleEmailAuth} className="space-y-5">
            <div>
              ...
              <input
                ...
                required
                className="w-full h-10 px-4 border border-gray-300 rounded-lg text-sm placeholder:text-gray-400 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/10 transition-all"
          ...
          <div className="space-y-4">
            <Button
              ...
              disabled={loading}
              type="button"
              className="w-full h-10 bg-white border border-gray-300 hover:bg-sky-50 text-gray-700 text-sm font-medium rounded-lg transition-colors flex items-center justify-center gap-3"
            >
          ...
          {!isLogin && (
            <p className="mt-6 text-xs text-gray-500 text-center leading-relaxed">
              アカウント作成により、
              <a href="#" className="text-sky-500 hover:text-sky-600 transition-colors">利用規約</a>
              および
              <a href="#" className="text-sky-500 hover:text-sky-600 transition-colors">プライバシーポリシー</a>
              に同意したことになります
            </p>
          )}
        </Card>
